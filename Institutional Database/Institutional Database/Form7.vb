Public Class Form7
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Form4.Show() 'show previous form and
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        Else
            Timer1.Enabled = True  'else enable it back
        End If
    End Sub
...
"C:\Users\Admin\Documents\mcont.txt"
        If System.IO.File.Exists(FILE_NAME3) = True Then
            ...
            End While
        End If
        'stores institute website links in link array
...
"C:\Users\Admin\Documents\mlink.txt"
        ...
        PictureBox1.Image = My.Resources.ResourceManager.GetObject("pic" & counter + 1)
        Label1.Text = inst(counter)
        Label2.Text = info(counter)
        Label3.Text = add(counter)
        LinkLabel1.Text = web(counter)
        BackgroundImage = My.Resources.ResourceManager.GetObject("mbg" & counter + 1)
    End Sub
    'Previous button
    ...
    Private Sub Timer1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        Call Button4_Click(sender, e) 'on every timer click, go to the next slide, i.e., follow same procedure as the Next button
    End Sub
End Class